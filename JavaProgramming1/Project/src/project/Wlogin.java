                                ...
                                if (uid1.equals("") || upass2.equals("")) {
                                        ...
                                        try {
                                                ...
                                                if (customer.logincheck(uid1, upass2) != null) {
                                                        ...
                                                        dbUpdate.SelectSeat();
                                                        int index = dbUpdate.SelectSeat() -1;
...
//panel7 결제화면
                ...
                for (JButton seatBtnn : seatBtn) {
                	int index = Arrays.asList(seatBtn).indexOf(seatBtnn);
                	List<Integer> listNotNull = dbUpdate.SeatNotNull();
                	boolean isContains = listNotNull.contains(index+1);
                	if(isContains) {
                		seatBtnn.setBackground(Color.red);
                        seatBtnn.setEnabled(false);
                	} else {
                		seatBtnn.setBackground(new Color(0, 128, 255));
                        seatBtnn.setForeground(new Color(255, 255, 255));
                        seatBtnn.setEnabled(true);
