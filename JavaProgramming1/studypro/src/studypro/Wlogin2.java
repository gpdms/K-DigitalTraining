...
//-------------Swing----------------------------------------------------------------------------
                ...
                lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\admin\\Downloads\\중앙스터디카페2.png"));
                ...
                lblNewLabel_1_2.setIcon(new ImageIcon("C:\\Users\\admin\\Downloads\\중앙스터디카페2.png"));
...
//panel7 결제화면
                ...
                panel7.add(paymoney);
                                ...
                                panel_4_1.setBounds(0, 0, 1155, 59);
                                panel8.add(panel_4_1);
                                
                                JLabel lbTime1_7 = new JLabel("New label");
                                lbTime1_7.setFont(new Font("HY견고딕", Font.PLAIN, 30));
                                lbTime1_7.setBounds(884, -19, 284, 119);
                                panel_4_1.add(lbTime1_7);
                                
                                JPanel panel_1_3_1 = new JPanel();
                                panel_1_3_1.setLayout(null);
                                panel_1_3_1.setBackground(Color.LIGHT_GRAY);
                                panel_1_3_1.setBounds(0, 58, 1155, 31);
                                panel8.add(panel_1_3_1);
                                                ...
                                                panel8.add(lbTime1_6);
                                                                ...
                                                                panel8.add(BtnOne);
                                                                                ...
                                                                                lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\admin\\Downloads\\중앙스터디카페2.png"));
                                                                                ...
                                                                                panel8.add(lblNewLabel_2);
                                                                                                ...
                                                                                                panel8.add(nameLabel);
                                                                                                                ...
                                                                                                                starttimeLabel.setBounds(250, 378, 764, 52);
                                                                                                                panel8.add(starttimeLabel);
                                                                                                                
                                                                                                                                JLabel endtimeLabel = new JLabel("New label");
                                                                                                                                endtimeLabel.setFont(new Font("HY견고딕", Font.PLAIN, 25));
                                                                                                                                endtimeLabel.setBounds(250, 450, 766, 52);
                                                                                                                                panel8.add(endtimeLabel);
                                                                                                                                
                                                                                                                                                JLabel paypriceLabel = new JLabel("New label");
                                                                                                                                                paypriceLabel.setFont(new Font("HY견고딕", Font.PLAIN, 25));
                                                                                                                                                paypriceLabel.setBounds(248, 519, 766, 52);
                                                                                                                                                panel8.add(paypriceLabel);
                                ...
                                public void actionPerformed(ActionEvent e) {
                                        ...
                                        if (nhyyf) {
                                                ...
                                                if (answer == JOptionPane.YES_OPTION) {
                                                        ...
                                                        dbUpdate2.SelectSeat();
                                                        int index4 = dbUpdate2.SelectSeat();
                                                        System.out.println(index4);

                                                        if (index4 != 0) {
                                                                JOptionPane.showMessageDialog(null, "이미 좌석을 선택한 기록이 있습니다");
...
//                });
                        ...
                        public void actionPerformed(ActionEvent e) {
                                ...
                                if (answer == JOptionPane.YES_OPTION) {
                                        ...
                                        endtimeLabel.setText("입실 종료 시각 : " + dbUpdate2.selectouttime() + "시 "
                                                        + dbUpdate2.selectStartminute() + "분 " + dbUpdate2.SelectSeat() + "초");
                                        paypriceLabel.setText("구매한 가격 : " + dbUpdate2.selectpayprice() + "원");
                                        panel7.setVisible(false);
                ...
                Thread th2 = new Thread() {
                        ...
                        public void run() {
                                ...
                                while (true) {
                                        ...
                                        lbTime1_7.setText(now.getHour() + " 시 " + now.getMinute() + " 분 " + now.getSecond() + " 초 ");
                                }
                        }
                };
                ...
                int[] payprice = { 2000, 4000, 7000, 10000, 13000, 15000 };
                        ...
                        priceBtnn.addActionListener(new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent e) {
                                        ...
                                        if (answer == JOptionPane.YES_OPTION) {
                                                ...
                                                System.out.println(payprice[index2]);
                                                dbUpdate2.paytime(pricenum[index2]);
                                                dbUpdate2.paytimeUpdate();
                                                dbUpdate2.payprice(payprice[index2]);
                                                dbUpdate2.paypriceUpdate();
