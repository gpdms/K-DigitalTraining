...
%>
	...
	<div id="wrapper">
			<form action="profimg.jsp" method="post" enctype="multipart/form-data">
				<div id="userInfo">
					<img id="img" src="image/blankProfile.jpg" alt="프로필사진">
					<input type="file" name="fileName" id="profimg">
					<div id="userID"><a href="updateMyinfoForm.jsp?studentNum=<%=user.getStudentNum() %>"><%=user.getUserID() %></a></div>
					<div id="nickName"><a href="updateMyinfoForm.jsp?studentNum=<%=user.getStudentNum() %>"><%=user.getNickName() %></a></div>
				</div>
			</form>
